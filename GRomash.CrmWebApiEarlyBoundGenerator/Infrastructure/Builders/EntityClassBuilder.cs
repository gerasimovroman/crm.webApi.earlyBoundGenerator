                        ...
                        Statements =
                        {
                            ...
                            new CodeConditionStatement(new CodeSnippetExpression("value != null"), new CodeStatement[]
                            {
                                new CodeConditionStatement(new CodeSnippetExpression("value is string stringValue && " +
                                    ...
                                    new CodeStatement[]
                                    {
                                        new CodeConditionStatement(new CodeSnippetExpression("value is ExpandoObject valueExpandoObject"),
                                            new CodeStatement[]
                                            {
                                                new CodeVariableDeclarationStatement("var", "propertyWithEntityAttribute",
                                                    new CodeSnippetExpression("GetPublicInstanceProperties().FirstOrDefault(x => x.GetCustomAttribute<EntityAttribute>()?.AttributeName == valueFieldName)")),
                                            ...
                                            new CodeStatement[]
                                            {
                                                new CodeVariableDeclarationStatement("var", "propertyForField",
                                                    new CodeSnippetExpression("GetPublicInstanceProperties().FirstOrDefault(x => x.Name.Equals(valueFieldName, StringComparison.CurrentCultureIgnoreCase))")),
                                ...
                                new CodeConditionStatement(new CodeSnippetExpression("convertValueToType != null"),
                                    new CodeStatement[]
                                    {
                                        new CodeConditionStatement(
                                            ...
                                            {
                                                new CodeAssignStatement(new CodeVariableReferenceExpression("convertValueToType"),
                                                    new CodeSnippetExpression("Nullable.GetUnderlyingType(convertValueToType)")),
                                            }),
                                ...
                                new CodeConditionStatement(new CodeMethodInvokeExpression(new CodeVariableReferenceExpression("valueFieldName"),
                                    "EndsWith",
                                    new CodeVariableReferenceExpression("formattedAttributePostFix")),
                                    new CodeStatement[]
                                    {
                                        new CodeExpressionStatement(new CodeMethodInvokeExpression(new CodeVariableReferenceExpression("FormattedValues"), "Add",
                                            new CodeExpression[]
                                        {
                                            new CodeMethodInvokeExpression(new CodeVariableReferenceExpression("valueFieldName"), "Replace",
                                                new CodeExpression[]
                                            {
                                                new CodeVariableReferenceExpression("formattedAttributePostFix"),
                                    ...
                                    new CodeStatement[]
                                    {
                                        new CodeExpressionStatement(new CodeMethodInvokeExpression(new CodeVariableReferenceExpression("Attributes"),
                                            "Add",
                                            new CodeExpression[]
                                            {
